...
<div>
    ...
    <div class="containerr">
        ...
        <form-message v-if="errorTa == 1" @cancel="close" content="Chọn tên table để tiếp tục..." />
        ...
        <div class="mapping">
            <div v-if="dbColumns.length">
                <form @submit.prevent="submitMapping">
                    <h3 class="text-center">Điền các cột trong file excel tương ứng với các trường trong database</h3>
                    <div v-for="(column, index) in dbColumns" :key="index">
                        <div>
                            <div v-if="column.isIdentity" class="form-group">
                                ...
                                <input disabled placeholder="Khóa chính tự tăng" class="form-control" v-model="columnMappings[column]" :id="'dbColumn_' + index" />
                            </div>
